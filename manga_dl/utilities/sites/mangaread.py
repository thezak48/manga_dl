"""
This module defines the Mangaread class for interacting with the website mangaread.org.

The Mangaread class provides methods to fetch manga IDs, chapters, images, 
and metadata from mangaread.org, and to download manga images and save them as .cbz files.
...
class Mangaread:
    """
    A class to interact with the website mangaread.org.
    ...
    headers_post.update(
        {
            ...
            "origin": "https://mangaread.org",
            "referer": "https://mangaread.org/manga/the-school-beauty-president-is-all-over-me/",
    ...
    def get_manga_id(self, manga_name: str):
        ...
        url = f"https://mangaread.org/manga/{manga_name}"
